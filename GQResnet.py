...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        width = int(planes * (base_width / 128.)) * groups
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=6, zero_init_residual=False,
                 groups=1, width_per_group=128, replace_stride_with_dilation=None,
                 norm_layer=None):
        ...
        self.conv1 = nn.Conv2d(95, self.inplanes, kernel_size=7, stride=2, padding=3,
                               bias=False)
...
def resnet18(progress=True, **kwargs):
    ...
    """
    return _resnet(BasicBlock, [2, 2, 2, 2], progress,
                   **kwargs)
...
def resnet50(progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(Bottleneck, [3, 4, 6, 3], progress,
                   **kwargs)
...
def resnet101(progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(Bottleneck, [3, 4, 23, 3], progress,
                   **kwargs)
...
def resnet152(progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(Bottleneck, [3, 8, 36, 3], progress,
                   **kwargs)